...
const routes: Routes = [
  ...
  { path: 'eventos', component: ListaEventosComponent, pathMatch: 'full' },
  { path: 'registro-eventos', component: RegistroEventoComponent, pathMatch: 'full' },
  { path: 'registro-eventos/:id', component:RegistroUsuariosScreenComponent, pathMatch: 'full'},
];
